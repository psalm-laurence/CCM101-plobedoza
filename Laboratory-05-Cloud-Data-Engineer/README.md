...
Through this activity, I learned how to deploy an object storage server using Docker. I also learned how to use the MinIO Web Console, create a bucket, and upload files. In addition, I improved my understanding of the differences between Block, File, and Object Storage and practiced documenting technical procedures using Markdown.
